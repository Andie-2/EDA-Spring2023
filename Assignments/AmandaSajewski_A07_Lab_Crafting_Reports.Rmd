...
```{r Boxplots, fig.cap="Ozone Levels in 2018 & 2019", echo=FALSE}

EPA_air_2018 <- filter(epa_data,Year=="2018")

EPA_air_2018$Month <- factor(EPA_air_2018$Month,levels = 1:12, labels = month.abb)

EPA_air_2019 <- filter(epa_data,Year=="2019")

EPA_air_2019$Month <- factor(EPA_air_2019$Month,levels = 1:12, labels = month.abb)
