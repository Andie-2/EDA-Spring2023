...
> Answer: 
Little to no experiences. I used R to run population genetics dynamics models during undergrad but with step by step instructions.

2. Are there any components of the course about which you feel confident?

> Answer: 
I learn fast, I'm hoping to become pretty confident using R

3. Are there any components of the course about which you feel apprehensive?

> Answer: 
That remains to be seen. Probably the final project.
